        ...
        builder: (context, state) {
          ...
          borderRadius: BorderRadius.circular(16),
              ...
              padding: const EdgeInsets.all(20),
                      child: SvgPicture.asset(Assets.imagesCheck,width: 70,height: 50,color: Colors.white,))),
                  ],),
                ),
                content: Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: defulttext(data:  "تم تغيير كلمة المرور بنجاح",fSize: 18,fw: FontWeight.w700),
                ),
              ),
            );
                          }
